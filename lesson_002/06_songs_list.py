...
# TODO здесь ваш код
time1 = violator_songs_list[3][1] + violator_songs_list[5][1] + violator_songs_list[-1][1]
print('Three songs sounds', round(time1, 2), 'minutes')
...
print('Other three songs sounds', round(time2, 2), 'minutes')